...
namespace QuantConnect.Lean.Engine.Setup
{
    ...
    public class BacktestingSetupHandler : ISetupHandler
    {
        ...
        public virtual IAlgorithm CreateAlgorithmInstance(AlgorithmNodePacket algorithmNodePacket, string assemblyPath)
        {
            ...
            var loader = new Loader(debugging, algorithmNodePacket.Language, BaseSetupHandler.AlgorithmCreationTimeout, names => names.SingleOrAlgorithmTypeName(UserConfig.Get("algorithm-type-name")), WorkerThread);
